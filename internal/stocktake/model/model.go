...
type StocktakeLine struct {
	...
	BookQtyAt      time.Time       `gorm:"column:book_qty_at;type:datetime;not null" json:"book_qty_at"`
...
type StocktakeLineOperation struct {
	...
	OpAt       time.Time       `gorm:"column:op_at;type:datetime;not null;index" json:"op_at"`
